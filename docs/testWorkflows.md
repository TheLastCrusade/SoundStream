...
### Expected Results: ###
 Upon removal of last song, a toast appears instructing the user to add songs to the playlist. Upon pressing play, there is no song in the playlist and a toast appears stating that the Playlist is Empty on phone A
...
### Expected Results: ###
 Upon removal of last song, a toast appears instructing the user to add songs to the playlist. Upon pressing play, there is no song in the playlist and a toast appears stating that the Playlist is Empty on phone B
...
## Test 17a: Bump transferring behind next available song ##
...
## Test 17b: Bump transferring song behind next available when next available is more than 2 songs away ##
...
## Test 18a: Remove transferred song added by host ##
...
## Test 18b: Remove transferred song added by host with action(s) initiated by guest ##
...
## Test 18c: Remove transferred song added by guest with action(s) initiated by host ##
...
## Test 18d: Remove transferred song added by guest with action(s) initiated by guest ##
...
## Test 19a: Remove partially transferred song added by host ##
...
## Test 19b: Remove partially transferred song added by host with action(s) initiated by guest ##
...
## Test 19c: Remove partially transferred song added by guest with action(s) initiated by host ##
...
## Test 19d: Remove partially transferred song added by guest with action(s) initiated by guest ##
...
## Test 20: Disconnect guest with user action (pressing disconnect button) ##
...
## Test 21: Disconnect guest by dropping the bluetooth socket ##
...
## Test 22: Play songs transferred from disconnected guest ##
...
## Test 23: Disconnect guest while song is transferring from guest ##
...
- Press the Disconnect button on phone B
- Press Create on phone B
- Press the Play icon in the playbar on phone
- *Follow Test 9 to Reconnect phone B to phone A's Network*
...
## Test 25: Connect 3 phones using host to add ##
...
## Test 26: Remotely add a third phone ##
...
## Test 27: Play events and status synced between all phones ##
...
## Test 28: Add and remove events synced between all phones ##
...
## Test 29: Add a second guest into an existing network ##
...
## Test 30: Transfer song events synced between all phones ##
...
## Test 31: Transfer a song from a different guest ##
...
## Test 32: Remove a transferred song added by a different guest ##
...
## Test 33: Remove a partially transferred song added by a different guest ##
...
## Test 34: Disconnect one guest with user action (pressing disconnect button) ##
...
## Test 35: Disconnect one guest by dropping the bluetooth socket ##
