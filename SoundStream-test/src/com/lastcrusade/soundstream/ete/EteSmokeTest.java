...
public class EteSmokeTest extends ActivityInstrumentationTestCase2<CoreActivity> {
	...
	public void testOpenClose() throws Exception {
		...
		assertUtils.assertFragmentVisible(solo, PlaybarFragment.class, false);
		...
		assertUtils.assertFragmentVisible(solo, PlaylistFragment.class, true);
		assertUtils.assertFragmentVisible(solo, PlaybarFragment.class, true);
		solo.clickOnImage(0);

		solo.clickOnButton("Music Library");
		assertUtils.assertFragmentVisible(solo, MusicLibraryFragment.class, true);
		assertUtils.assertFragmentVisible(solo, PlaybarFragment.class, true);
		solo.clickOnImage(0);
		
		solo.clickOnButton("About");
		assertUtils.assertFragmentVisible(solo, AboutFragment.class, true);
		assertUtils.assertFragmentVisible(solo, PlaybarFragment.class, true);
		solo.clickOnImage(0);
