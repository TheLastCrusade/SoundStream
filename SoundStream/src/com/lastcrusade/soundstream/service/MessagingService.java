...
public class MessagingService extends Service implements IMessagingService {
    ...
    private void sendMessageToFan(String address, IMessage msg) {
        try {
            if (this.connectServiceLocator.getService().isFanConnected(address)) {
                this.connectServiceLocator.getService().sendMessageToFan(address, msg);
            }
